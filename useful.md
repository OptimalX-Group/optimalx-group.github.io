...
- *Control Bootcamp* by Steve Brunton  
  - <span style="font-size: smaller;">[Video Lectures](https://youtube.com/playlist?list=PLMrJAkhIeNNR20Mz-VpzgfQs5zrYi085m&feature=shared)</span>
  - <span style="font-size: smaller;">[Book](http://databookuw.com)</span>  
- *Linear Dynamical Systems* by Stephen Boyd  
  - <span style="font-size: smaller;">[Lecture Notes](https://stanford.edu/class/ee363/)</span> 
- *Convex Optimization: Algorithms and Complexity* by Sebastien Bubeck
  - <span style="font-size: smaller;">[Book](https://arxiv.org/abs/1405.4980)</span>  

#### C) Nonlinear Optimization Algorithms
- *Numerical Optimization* by Jorge Nocedal and Stephen Wright
  - <span style="font-size: smaller;">[Book](https://www.math.uci.edu/~qnie/Publications/NumericalOptimization.pdf)</span>  

#### D) Game Theory
- *Algorithmic Game Theory* by Bryce Wiedenbeck
  - <span style="font-size: smaller;">[Video Lectures](https://youtu.be/8kzElA08D9w?feature=shared)</span>
  - <span style="font-size: smaller;">[Book](https://clearoboticslab.github.io/books/)</span>
...
- *Writing in The Science* by Kristin Sainani  
  - <span style="font-size: smaller;">[Video](https://youtu.be/x33Km7hRzP0?feature=shared)</span>
- *The Elements of Style* by E. B. White and William Strunk Jr.  
  - <span style="font-size: smaller;">[Book](https://www.jlakes.org/ch/web/The-elements-of-style.pdf)</span>
